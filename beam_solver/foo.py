...
class BeamFunc():
    ...
    def remove_degen(self, ls, obsbeam, threshold=3e-4):
        """
...
class BeamCatCross(BeamCat):
    ...
    def construct_nonlinear_sys(self, catalog_flux_xx, catalog_flux_yy, beamvals=[], theta_xx=[0], theta_yy=[], flip_xx=[1], flup_yy=[1], constrain=False):
        """
        Construct a non linear system of equations of the form
...
class BeamCatSolve(BeamSolveBase, BeamSolveCross):
